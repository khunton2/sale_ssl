                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="inputcompany" class="col-sm-2 col-form-label">รูปภาพประกอบ</label>
                                            <div class="col-sm-10">
                                                <input type="file" id="company" name="company" class="form-control"
                                                    placeholder="ชื่อบริษัท" aria-label="Disabled input example">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputquestion_number"
                                                class="col-sm-2 col-form-label">ราคา</label>
                                            <div class="col-sm-10">
                                                <input id="question_number" name="question_number" class="form-control"
                                                    placeholder="ราคา" aria-label="Disabled input example">
                                            </div>
                                        </div>
