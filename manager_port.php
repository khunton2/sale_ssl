                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">table port</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><?= $k['off_name'];?></td> -->
                                            <td>25%</td>
                                            <td><a class="btn btn-primary" href="manager_Scheduling.php"><i
                                                        class="fa-solid fa-calendar-days"></i></a></td>



                                            <!-- <td><a class="btn btn-primary" href="saler_port.php"><i
