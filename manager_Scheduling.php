            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="manager_add.php">appointment</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="cardt rounded-0 shadow">
                                            ...
                                            <div class="card-body">
                                                <div class="container-fluid">
                                                    <form action="query/save_schedule.php" method="post"
                                                        id="schedule-form">
