                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="name" name="name" class="form-control" placeholder="ชื่อ"
                                                    aria-label="Disabled input example">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputsurname" class="col-sm-2 col-form-label">นามสกุล</label>
                                            <div class="col-sm-10">
                                                <input id="surname" name="surname" class="form-control"
                                                    placeholder="นามสกุล" aria-label="Disabled input example">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="username" name="username" class="form-control"
                                                    placeholder="username" aria-label="Disabled input example">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="password" name="password" class="form-control"
                                                    placeholder="Password" aria-label="Disabled input example">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="tel" name="tel" class="form-control" placeholder="เบอร์โทร"
                                                    aria-label="Disabled input example">
                                            </div>
                                        </div>

                                        <div class="mb-3 row">
                                            <label for="inputuserlevel" class="col-sm-2 col-form-label">ระดับ</label>
                                            <div class="col-sm-10">
                                                <select class="form-select form-select-sm"
                                                    aria-label="Small select example" id="userlevel" name="userlevel">
                                                    <option selected>เลือกระดับผู้ใช้งาน</option>
                                                    <option value="admin">admin</option>
                                                    <option value="manager">manager</option>
                                                    <option value="seller">intern</option>
                                                </select>
                                            </div>
                                        </div>
...
//   exit();
  ...
  if (isset($_POST['name']) && isset($_POST['surname']) && isset($_POST['username']) && isset($_POST['password'])&& isset($_POST['tel']) && isset($_POST['userlevel'])) {
  //ไฟล์เชื่อมต่อฐานข้อมูล
  require_once 'connectDB/connectDB.php';
      //sql insert
      $stmt = $conn->prepare("INSERT INTO tbl_user(id, name,surname,username,password,tel,userlevel)
      VALUES
      (null,:name,:surname,:username, :password, :tel,:userlevel)
      ");
      //bindParam data type
  ...
  echo '<script>
      ...
      window.location = "ad_adduser.php"; //หน้าที่ต้องการให้กระโดดไป
      });
    }, 1000);
  </script>';
  }else{
